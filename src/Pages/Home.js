...
export default function Home() {
    ...
    <Box>
        ...
        <Box sx={{backgroundColor:"#f4f4f4",marginTop:"7vh",minWidth:"100vw",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
                ...
                <Button onClick={()=>{history.push("/choose")}} variant="contained" size="large"><Typography variant='h5' sx={{fontSize:{xs:"1.4rem",md:"2rem"}}} fontFamily="Bree Serif" color="white">Get Started</Typography></Button>
