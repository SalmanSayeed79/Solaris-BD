    ...
    <Box>
        <AppBar color="default">
            <Toolbar>
                ...
                {showTiltAngle && <Typography fontFamily="Bree Serif" color="primary" fontSize="large">Optimal Tilt Angle</Typography>}
            </Toolbar>
        </AppBar>
        {!showData && <Box sx={{backgroundColor:"#f4f4f4",marginTop:"7vh",width:"100vw",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-start"}}>
                ...
                <ButtonGroup sx={{marginBottom:"5vh",orientation:{xs:"vertical",md:"horizontal"}}}>
                  <Button onClick={()=>{setShowTiltAngle(true);setShowData(true)}}  variant="contained" size="large" sx={{marginTop:"50px"}}><Typography variant='p' sx={{fontSize:{xs:"1rem",md:"1.5rem"},}} fontFamily="Bree Serif" color="white">Get Optimal Tilt Angle</Typography></Button>
                </ButtonGroup>

                
        </Box>}
        {showTiltAngle && <OptimalTilt lat={lat} lng={lng}/>}
