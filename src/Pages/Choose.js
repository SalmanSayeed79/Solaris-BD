    ...
    return (
        ...
        <AppBar color="default">
            ...
            <Box sx={{backgroundColor:"#ff9800",marginTop:"7vh",minWidth:"100vw",height:"93vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
                ...
                <Button variant="contained" color="success" size="large" sx={{marginTop:"2rem"}}><Typography variant='h5' sx={{fontSize:{xs:"1.4rem",md:"2rem"}}} fontFamily="Bree Serif" color="#ff9800">Farming Data</Typography></Button>
