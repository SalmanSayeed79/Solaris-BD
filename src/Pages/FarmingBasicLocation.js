...
import YearlyFarmingBasic from './YearlyFarmingBasic';
import MonthlyFarmingBasic from "./MonthlyFarmingBasic"
...
export default function FarmingBasicLocation() {
    ...
    <Box>
        ...
        {showYearlyData && <YearlyFarmingBasic lat={lat} lng={lng}/>}
        {showMonthlyData && <MonthlyFarmingBasic lat={lat} lng={lng}/>}
    </Box>
    )
}
