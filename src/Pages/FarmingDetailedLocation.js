...
import YearlyFarming from './YearlyFarmingBasic';
import MonthlyFarming from "./MonthlyFarmingBasic"
...
export default function FarmingDetailedLocation() {
    ...
    <Box>
        ...
        {showYearlyData && <YearlyFarming lat={lat} lng={lng}/>}
        {showMonthlyData && <MonthlyFarming lat={lat} lng={lng}/>}
    </Box>
    )
}
